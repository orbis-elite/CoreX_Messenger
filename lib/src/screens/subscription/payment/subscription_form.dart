...
class _SubscriptionFormState extends State<SubscriptionForm> {
  ...
  void _initializeControllers() {
    ...
    final userName = fullName.isNotEmpty ? fullName : (userBox.get('userName') ?? '');
    ...
    final isEmailConfirmed = userBox.get('is_subscription_email_confirmed', defaultValue: false);
    ...
    _isEmailConfirmed = isEmailConfirmed && confirmedEmail != null && confirmedEmail.isNotEmpty;
  }
            ...
            Container(
              ...
              child: TextButton(
                onPressed: () async {
                  ...
                  final userBox = Hive.box('userdata');
                  await userBox.put('confirmed_subscription_email', _emailController.text.trim());
    ...
    return Dialog(
      ...
      child: Container(
        ...
        constraints: BoxConstraints(
          ...
          maxHeight: keyboardHeight > 0 ? availableHeight * 0.9 : screenHeight * 0.85,
        ),
        decoration: BoxDecoration(
          color: appColorWhite,
          ...
          children: [
            ...
            Flexible(
              child: Scrollbar(
                ...
                trackVisibility: keyboardHeight > 0, // Show track when keyboard is visible
                                  ...
                                  child: Container(
                                    ...
                                    child: ElevatedButton(
                                      ...
                                      child: _isLoading
                                          ...
                                          : Text(
                                              _isEmailConfirmed ? 'Proceed to Payment' : 'Continue Payment',
                                              style: TextStyle(
                                                fontSize: 16,
                                                fontWeight: FontWeight.bold,
                                                color: Colors.white,
